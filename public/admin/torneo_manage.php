...
<style>
  ...
  .card-title{ margin:0 0 10px; font-size:16px; font-weight:800; color:#dbeafe; letter-spacing:.3px; }
  ...
  /* Inputs/Select coerenti con il tema */
  ...
  /* Celle azioni della tabella (Applica/Elimina) */
  .actions-cell{ white-space:nowrap; display:flex; align-items:center; gap:8px; }

  /* Gruppo pulsanti (3 colonne) nelle impostazioni */
  .btn-grid-3{
  ...
  .round-select{ width:auto; min-width:160px; }

  /* Select degli eventi */
  .team-select, .result-select{ width:100%; }
</style>
