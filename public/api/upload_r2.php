<?php
// public/api/upload_r2.php — upload server-side verso R2 usando AWS SDK (fallback al presign)
...
if (!isset($_FILES['file'])) {
  http_response_code(422); echo json_encode(['ok'=>false,'error'=>'missing_file']); exit;
}
...
$cdn = getenv('S3_CDN_BASE'); // opzionale, per URL pubblico
...
try {
  ...
  echo json_encode(['ok'=>true, 'storage_key'=>$storage_key, 'url'=>$url, 'etag'=>$etag]);
